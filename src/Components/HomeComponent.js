...
const HomeComponent = () => {
  return (
    ...
    <div className='padding border-thing'>
    <Container className='padding'>

    <Row>
            <Col lg={6} sm={12} className='columns'> 
            <h1 className='title-smaller'>A bit about the project...</h1>
              <p>Vindicate is a Metroidvania / RPG game with many visual novel elements. This game's major focus its characters and storytelling, but also features turn-based combat and small puzzles to solve.</p>
              ...
              <Button variant="danger" as={Link} to='/about'>View More Content Here!</Button>{' '}
            </Col>
            <Col lg={6} sm={12} className='columns'>  
              ...
              <p></p>
              <Button variant="danger" as={Link} to='/about'>View Development so Far!</Button>{' '}
            </Col>
          </Row>
