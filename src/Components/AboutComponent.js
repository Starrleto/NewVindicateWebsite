  ...
  return (
    <div>
        ...
        <div className='padding'>
          ...
          <p className='text-left'>There's currently no set release date, although my personal goal is to create at least a playable product by the end of this year (2024).</p>
